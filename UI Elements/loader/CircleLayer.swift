...
class CircleLayer: CALayer {
    ...
    func layerWithWithBounds(bounds:CGRect, position:CGPoint, fromColor:UIColor, toColor:UIColor, linewidth : CGFloat,toValue:CGFloat) -> CircleLayer {
        let layer = CircleLayer(bounds: bounds,position: position,fromColor:fromColor, toColor: toColor,linewidth: linewidth,toValue:toValue )
        return layer
    }
    ...
    func animateCircle(duration: TimeInterval) {
        animateCircleTo(duration: duration, fromValue: 0.010, toValue: 0.33)
    }
    ...
    func animateCircleTo(duration: TimeInterval, fromValue: CGFloat, toValue: CGFloat) {
        ...
        circleMask.strokeStart = fromValue
