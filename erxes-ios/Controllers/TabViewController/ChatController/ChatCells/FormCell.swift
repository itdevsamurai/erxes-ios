...
//  erxes-ios
//
//  Created by Purev-Yondon on 9/12/18.
...
var css = "<style>table{border-collapse: collapse; color: #444; font-family:Roboto,Arial,sans-serif; font-size:12px; min-width:100%; line-height:18px;} table, th, td {border: 1px solid #eee; padding: 5px 10px; } tr:nth-child(even) {background-color: #F7F8FC;font-weight:bold;}tr:first-child {text-align:center; font-size:11px; text-transform:uppercase; font-weight:bold;}</style>"
